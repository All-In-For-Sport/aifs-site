    ...
    <div className="page-wrap py-12">
      <div className="prose lg:prose-xl">
        ...
        <p className="mb-4 text-white/50">
          ...
          or that you may provide (“Personal Information”) on the
          allinforsport.org website (“Website” or “Service”) and any of its
        ...
        <h3 className="mt-4 text-xl font-semibold text-white">Data breach</h3>
        <p className="text-white/50">
        ...
        <h3 className="mt-4 text-xl font-semibold text-white">Contacting us</h3>
        <p className="text-white/50">
