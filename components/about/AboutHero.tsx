...
export default function AboutHero() {
    return (
        <section className="flex flex-col lg:flex-row justify-between gap-8">
            <div className="flex flex-col text-center lg:text-left items-center lg:items-start w-full lg:w-7/12">
                <Tag>About us</Tag>
                ...
                <p className="text-base text-white/50 mt-8">
                    ...
                    organization (DAO) whose mission is to create a public goods
                    funding initiative to support projects that advance
                    inclusion and empowerment through sport.
                </p>
                <div className="flex gap-2.5 mt-12">
                    <PrimaryButton>Our Projects</PrimaryButton>
                    <GhostButton>Get updates</GhostButton>
                </div>
                <div className="grid text-left grid-cols-1 lg:grid-cols-2 mt-16 lg:mt-12 gap-8 lg:gap-6">
            ...
            <div className="relative border w-full lg:w-5/12"></div>
        </section>
    );
}
