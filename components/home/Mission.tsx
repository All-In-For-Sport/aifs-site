    ...
    <section className="flex gap-16 flex-col-reverse max-w-xl lg:max-w-none lg:flex-row items-center my-12 lg:my-24">
      ...
      <div className="flex flex-col items-center text-center lg:text-left lg:items-start gap-6">
        ...
        <p className="text-white/50 max-w-md lg:max-w-none">
          ...
          <br />
          <br />
          Our learning journey begins with sports-loving cities in North America
          including <span className="text-primary font-bold">
            Oakland
          </span>, <span className="text-primary font-bold">Toronto</span> and{" "}
          <span className="text-primary font-bold">Los Angeles</span>, and
          international basketball communities in the{" "}
          <span className="text-primary font-bold">Philippines</span> and{" "}
