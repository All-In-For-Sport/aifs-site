...
export default function Mission() {
  return (
    <section>
      <div className="page-wrap flex gap-16 flex-col-reverse max-w-xl lg:flex-row items-center py-12 lg:py-24">
        ...
        <div className="flex flex-col items-center text-center lg:text-left lg:items-start gap-6">
          ...
          <p className="text-white/50 max-w-md lg:max-w-none">
            ...
            America including{" "}
            <span className="text-primary font-bold">Oakland</span>,{" "}
