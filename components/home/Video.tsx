      ...
      <div className="w-full h-full relative">
        <div className="absolute top-0 right-0 h-full -z-20 w-full bottom-0 left-0 mx-auto">
          <div className="top-0 max-w-screen py-12 min-h-screen overflow-visible w-full sticky flex items-center justify-center">
            <div className="w-full h-full md:w-[600px] md:h-[600px] rounded-full  bg-[#5A6DED] blur-[200px] md:blur-[100px] absolute left-0 right-0 top-0 transform translate-y-16 mx-auto my-auto" />
          </div>
        </div>
        ...
        >
          <motion.div
            style={{ scale }}
            className="w-full group bg-opacity-40 cursor-pointer relative rounded-2xl overflow-clip"
          >
            <video
